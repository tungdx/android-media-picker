...
import mediapicker.imageloader.MediaImageLoaderImpl;
import mediapicker.utils.MediaUtils;
import mediapicker.utils.MessageUtils;
...
public class MediaPickerActivity extends AppCompatActivity
  ...
  public static final String FLAG_IS_TAKE_PHOTO = "is_take_photo";
   ...
   */
  public static void open(Activity activity, int requestCode, boolean isTakePhoto) {
    open(activity, requestCode, MediaOptions.createDefault(), isTakePhoto);
  }
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    if (getActivePage() == null) {
      getSupportFragmentManager().beginTransaction()
          ...
          .commit();
      if (getIntent().getBooleanExtra(FLAG_IS_TAKE_PHOTO, false)) {
        takePhoto();
      }
    }
